      ...
      <div className={GROUP}>
        {SERVICES.map((svc) => (
          <button
            ...
            className={`flex w-full min-w-0 flex-wrap items-center gap-3 py-3.5 text-left transition-colors ${
          ...
          >
            ...
            <span className="typetype-adaptive-label min-w-0 flex-1 text-sm leading-tight text-fg">
              {svc.label}
            </span>
