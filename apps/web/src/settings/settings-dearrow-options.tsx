...
const SELECT =
  "typetype-adaptive-control h-9 w-full max-w-full rounded-md border border-border-strong bg-surface px-2.5 text-sm text-fg sm:w-56";
...
export function SettingsDeArrowOptions() {
  ...
  return (
    <>
      <label className={ROW}>
        <span className="typetype-adaptive-label flex min-w-0 flex-1 flex-col gap-1">
