...
export function OnboardingHeader({ mode, step }: Props) {
  ...
  return (
    <header className="border-b border-border pb-5">
      <p className="font-mono text-xs uppercase tracking-[0.2em] text-fg-soft">First login</p>
      <h1 className="mt-3 font-mono text-2xl sm:text-3xl font-semibold tracking-tight text-fg">
