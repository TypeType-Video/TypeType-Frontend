...
export function ResetTokenModal({ email, token, onClose, onCopied }: ResetTokenModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm" role="presentation">
      <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
        <dialog
          className="rounded-xl border border-zinc-700 bg-zinc-900 p-6 shadow-2xl max-w-sm w-full mx-4 [animation:modal-fade-in_0.2s_ease-out] pointer-events-auto"
          open
        >
          <div className="mb-4">
